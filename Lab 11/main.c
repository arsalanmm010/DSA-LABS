...
int main()
{
    ...
    {
        FILE * fptr = NULL;
        if((fptr=fopen("EmployeeData1.txt", "r")) == NULL)
        {
    ...
    {
        insert(root, my_array[i]);    /// Note that this function takes the address of a pointer as input.
    }
    }
    printf("\n\n");
    ...
    while(1)
    {
        ...
        switch (choice)
        {
            ...
            {
                FILE * fptr = NULL;
                if((fptr=fopen("EmployeeData1.txt", "w+")) == NULL)
                {
