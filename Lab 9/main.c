...
#define ARRAY_SIZE 1024  /// 16, 128, 1024, etc
...
flag = 0;
      do
         {
           while((*(ptr_array+pos) <= *(ptr_array+right) && (pos!=right)))
                 right--;
                  if(pos==right)
                     flag =1;
                   else if(*(ptr_array+pos)>*(ptr_array+right))
                       {
                        temp = *(ptr_array+pos);
                           *(ptr_array+pos) = *(ptr_array+right);
                              *(ptr_array+right) = temp;
                    ...
                    if(flag!=1)
                    {
                        while(( *(ptr_array+pos) >=  *(ptr_array+left)) && (pos!=left))
                        left++;
                        if(pos==left)
                                 flag =1;
                        else if( *(ptr_array+pos) < *(ptr_array+left))
                             {
                                temp = *(ptr_array+pos);
                                *(ptr_array+pos) = *(ptr_array+left);
                                *(ptr_array+left) = temp;
                                pos = left;
                             }
                    }
